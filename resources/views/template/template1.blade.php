		...
		<div class="container">
			<div class="header">
				...
				<div class="banner-info">
					<h1>{{$tdata->first_name}} <span>{{$tdata->middle_name.' '.$tdata->last_name}}</span></h1>
					<p style="font-color:#000">{{$tdata->short_info}}</p>
	...
	<div class="branding" id="home">
		<div class="container">
			<div class="col-md-3 mobi">
				<i class="mobile"> </i>
				<label> </label>
				<h4>{{$tdata->skills_list1}}</h4>
			</div>
			<div class="col-md-3 devic">
				<i class="device"> </i>
				<label> </label>
				<h4>{{$tdata->skills_list2}}</h4>
			</div>
			<div class="col-md-3 rock-1">
				<i class="rocket"> </i>
				<label> </label>
				<h4>{{$tdata->skills_list3}}</h4>
			</div>
			<div class="col-md-3 appl">
				<i class="apple"> </i>
				<h4>{{$tdata->skills_list4}}</h4>
			</div>
				<div class="clearfix"></div>
		</div>
	</div>
	<div class="b-design">
		<div class="container">
				<div class="col-md-6 dsg-1">
					<h3>Services</h3>
					<li>{{$tdata->service_name1.' -> '.$tdata->service_info1}}</li><br/>
					<li>{{$tdata->service_name2.' -> '.$tdata->service_info2}}</li><br/>
					<li>{{$tdata->service_name3.' -> '.$tdata->service_info3}}</li>
					
				</div>
				<div class="col-md-6 dsg-2">
					<img src="/aa/{{$tdata->image}}" class="img-responsive" alt="" />
				</div>
					<div class="clearfix"></div>
		</div>
	</div>
		...
		<div class="container">
			...
			<p>{{$tdata->long_info}}</p>
				...
				<div class="col-md-6 soci">
					<a href="{{$tdata->facebook_link}}"><i class="social"></i></a>
				</div>
					<div class="clearfix"></div>
		</div>			
				<div class="location">
					<div class="container">
						<div class="col-md-5 igb">
							<h6>LOCATION:<span>{{$tdata->address}}</span></h6>
						</div>
						<div class="col-md-4 pon">
							<h6>PHONE:<span>{{$tdata->phone_no}}<span></h6>
						</div>
						<div class="col-md-3">
							<h6>EMAIL:<a href="#">{{$tdata->email}}</a></h6>
						</div>
							<div class="clearfix"></div>
					</div>
				</div>
	 ...
	 <div class="portfolio"  id="portfolio">
		<div class="container">
			...
			<div id="portfoliolist">
					...
					<div class="col-sm-4">		
						 <a href="/aa/{{$tdata->portfolio_images1}}" class="swipebox"  title="Image Title"> <img src="/aa/{{$tdata->portfolio_images1}}" class="img-responsive" alt=""><span class="zoom-icon"></span> </a>
	                </div>
	                <div class="col-sm-4">		
						 <a href="/aa/{{$tdata->portfolio_images2}}" class="swipebox"  title="Image Title"> <img src="/aa/{{$tdata->portfolio_images2}}" class="img-responsive" alt=""><span class="zoom-icon"></span> </a>
	                </div>
	                <div class="col-sm-4">		
						 <a href="/aa/{{$tdata->portfolio_images3}}" class="swipebox"  title="Image Title"> <img src="/aa/{{$tdata->portfolio_images3}}" class="img-responsive" alt=""><span class="zoom-icon"></span> </a>
	                </div>
...
<section class="slider">
	...
	<div class="footer">
		<div class="container">
			<ul>
				<li><a href="{{$tdata->facebook_link}}"><i class="fb"></i></a></li>
				<li><a href="{{$tdata->google_link}}"><i class="goog"></i></a></li>
				<li><a href="{{$tdata->twitter_link}}"><i class="twt"></i></a></li>
