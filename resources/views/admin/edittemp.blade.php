	...
	<div class="widget-body custom-form">
		...
		<input type="hidden" name="_token" value="{{ csrf_token() }}" />
		  <div class="form-group">
			...
			<input type="text" class="form-control" name="template_name" value="{{$tempname->template_name}}" id="exampleInputEmail1" placeholder="" />
		  </div>
		  <div class="form-group">
			<label for="exampleInputFile">File input</label>
			<input type="file" id="exampleInputFile" value="{{$tempname->template_image}}" name="template_image" />
			@if(isset($tempname))
            <img src="/aa/{{$tempname->template_image}}" width="150px" height="150px">
            @endif
